...
function tableWidgets(): Widget[] {
  ...
  return [
    ...
    widget('host-toolbar', 'basic', { x: 410, y: 14, width: 980, height: 56, movable: false, onlyVisibleForSeat: ['seat-1'], linkedToSeat: ['seat-1'],
    ...
    widget('host-toolbar-panel', 'basic', { parent: 'host-toolbar', x: 104, y: 0, width: 870, height: 56, display: true, movable: false, color: '#0000' }),
    ...
    widget('collect-shuffle', 'button', { parent: 'host-toolbar-panel', x: 492, y: 9, width: 116, height: 36, text: '🔀 收拢洗牌', clickRoutine: collectAndShuffleRoutine }),
    widget('clear-seats', 'button', { parent: 'host-toolbar-panel', x: 614, y: 9, width: 116, height: 36, text: '👤 重置座位', clickRoutine: clearAllSeatsRoutine }),
    widget('reset-table', 'button', { parent: 'host-toolbar-panel', x: 736, y: 9, width: 116, height: 36, text: '🔄 整桌重置', color: '#74322b', clickRoutine: resetTableRoutine }),
