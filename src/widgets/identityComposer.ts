...
export function createIdentityComposerWidgets(): Widget[] {
  return [
    label('identity-composer-title', '👑 身份牌构成区｜人工抽取所需身份放入下区核对', 1560, 605, 500),
    freeZone('identity-composer-zone', '👑 本局身份构成区｜取出各模式身份牌（主/忠/反/内）放入此区', 1560, 635, 440, 210),
    widget('assemble-identities-btn', 'button', { x: 2020, y: 635, width: 125, height: 38, text: '📦 盖回洗牌合成',
    ...
    pileZone('final-identity-deck-zone', '🎴 编组身份牌堆', 2020, 685, 125, 110),
    widget('send-identities-btn', 'button', { x: 2020, y: 805, width: 125, height: 38, text: '🚀 送入主游戏桌',
